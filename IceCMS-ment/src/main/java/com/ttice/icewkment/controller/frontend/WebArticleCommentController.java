...
public class WebArticleCommentController {
  ...
  public List<ArticleComment> getallArticleComment(@PathVariable("articleId") Integer articleId) {
  ...
  public int getArticleCommentnum(@PathVariable("articleId") Integer articleId) {
  ...
  public List<ArticleCommentVO> getNewArticleComment(@PathVariable("num") Integer num) {
