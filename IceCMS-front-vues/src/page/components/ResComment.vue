    ...
    >
      ...
      <div class="h-full w-full">
        <div id="chatRecord" class="chat-body p-4">
          <div class="in finite-loading-container" data-v-ecb5dde6="">
            <div
            ...
            <div
              ...
              data-v-ecb5dde6=""
            >
              <div class="mt-10" data-v-ecb5dde6="">
                <img
                  src="static/picture/comments.svg"
                  class="w-80 mb-4"
                  data-v-ecb5dde6=""
                />
                <h5 class="mb-6" data-v-ecb5dde6="">还没有评论哦!</h5>
              </div>
            </div>
            <div
              class="infinite-status-prompt"
              ...
              data-v-ecb5dde6=""
            >
              <div class="mb-3 fs-12 text-muted" data-v-ecb5dde6="">
                全部数据已加载完毕……
              </div>
            </div>
            <div
            ...
            >
              <div data-v-ecb5dde6="">
                数据加载失败，
                <button class="btn btn-outline-theme btn-sm" data-v-ecb5dde6="">
                  重试
                </button>
              </div>
            </div>
