    ...
    >
      <div class="box">
        ...
        <el-form-item prop="email">
          ...
          <div class="verification-code" style="display:flex;justify-content: space-between;">
            <el-form-item style="width:200px;margin-top: 20px;" prop="status">
            <el-input
              ref="status"
          ...
          <el-button size="mini" v-if="!buttonClicked" @click="handleClick()" type="primary">发送验证码</el-button>
            <span v-else>{{ countdown }} seconds left</span>
          </div>
        <div>个人信息</div>
          </el-form-item>
          ...
          <el-form-item prop="academic">
            <el-input
              ref="academic"
              v-model="RegisterForm.academic"
              placeholder="学历"
              name="academic"
              type="text"
              tabindex="1"
          ...
          <el-form-item prop="permanent">
            <el-input
              ref="permanent"
              v-model="RegisterForm.permanent"
              placeholder="常住地"
              name="permanent"
              type="text"
              tabindex="1"
                ...
                <div data-v-6d6103b4="" class="overflow-hidden">
                  ...
                  >
                    <a
                      ...
                      ><span data-v-6d6103b4="" class="fw-400">商品</span>
...
export default ({
  ...
  methods: {//用户注册
    ...
    handleClick() {
      testemail(this.RegisterForm.email).then(resp => {
        console.log(resp)
        if (resp.data == 1) {
          this.$message({
            message: '发送成功',
