...
export const constantRoutes = [
  ...
  {
    path: '/otheruserinfo/:id(\\d+)',
    component: () => import('@/page/OtherUserInfo'),
    hidden: true
  },
  {
    path: '/userinfo',
    ...
    children: [
      ...
      {
        path: '/userinfo/chat/:id(\\d+)',
        component: () => import('@/page/UserComponents/chat'),
      },
      {
      ...
      },
      {
        ...
        component: () => import('@/page/UserComponents/follow'),
      },
      {
