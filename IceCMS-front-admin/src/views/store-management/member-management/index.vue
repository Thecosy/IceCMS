...
<template>
  <div class="flex justify-between">
    ...
    /> -->
    <div style="width: 100%;" class="w-[calc(100%-200px)]">
        ...
        <template v-slot="{ size, dynamicColumns }">
          ...
          <pure-table ref="tableRef" row-key="id" adaptive align-whole="center" table-layout="auto" :loading="loading"
            ...
            <template #operation="{ row }">
              ...
              <el-popconfirm :title="`是否确认删除用户编号为${row.userId}的这条数据`" @confirm="handleDelete(row)">
                <template #reference>
              ...
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item>
                      <el-button :class="buttonClass" link type="primary" :size="size" :icon="useRenderIcon(Upload)"
