...
export default {
  data() {
    return {
      payid: "",
      cardStyle1: "background-color: #027CFF",
      cardStyle2: "background-color: #6DAE48",
      cardStyle3: "background-color: #B0332E",
      payJudej: true,
  ...
  methods: {
    Byclick1() {
      this.payid = "2",
        this.form.integral = '20';
      this.cardStyle1 = "background-color: rgba(0, 0, 0, 0.438);",
        this.cardStyle2 = "background-color: #6DAE48",
        this.cardStyle3 = "background-color: #B0332E"
    },
    Byclick2() {
      this.payid = "3",
        this.form.integral = '78';
      this.cardStyle1 = "background-color: #027CFF",
        this.cardStyle2 = "background-color: rgba(0, 0, 0, 0.438);",
        this.cardStyle3 = "background-color: #B0332E"
    },
    Byclick3() {
      this.payid = "4",
        this.form.integral = '98';
      this.cardStyle1 = "background-color: #027CFF",
        this.cardStyle2 = "background-color: #6DAE48",
        this.cardStyle3 = "background-color: rgba(0, 0, 0, 0.438);"
    },
    // 查询订单状态
    queryOrderStatus() {
