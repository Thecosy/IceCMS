  ...
  <view class="template-protocol">
    ...
    <view class="tn-text-center tn-margin tn-text-lg plus-box" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      <view class="plus-text">
        <view class="tn-text-bold">IceCMS模板小程序，开源啦</view>
        <view class="tn-margin-bottom-xl">（会员有更多福利鸭）</view>
      </view>
      
      <view class="plus-text">
        <view class="tn-text-bold">IceCMS模板小程序，页面数量50+</view>
      ...
      <view class="plus-text">
        ...
        <view class="tn-margin-bottom-xl">（IceCMSUI会员免费拥有所有模板）</view>
      </view>
      ...
      <view class="plus-text">
        <view class="tn-text-bold">IceCMS北北，微信号：<text class="tn-text-bold tn-text-xxl" @click="copyWechat">tnkewo</text> </view>
      ...
      <view class="plus-text">
        <view class="tn-text-bold">IceCMS模板开始于2022年5月1日，上线于5月30日</view>
      ...
      <view class="plus-text">
        <view class="tn-text-bold">IceCMS感恩你的支持</view>
