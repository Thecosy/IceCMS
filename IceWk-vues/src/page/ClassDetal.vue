    ...
    <div data-server-rendered="true" id="__nuxt">
      ...
      <div id="__layout">
        <div data-fetch-key="0" class="app light macwk-animation">
          <div
            class="layout-min-full-height overflow-hidden special-content pb-8"
          >
                ...
                <div class="col-sm-12 col-xxl-10 offset-xxl-1">
                  <header class="text-center py-8">
                    <h1 class="fw-600 fs-60">
                      Best Tools for
                      <span class="text-primary hover-text-underline cursor"
                        >{{className}} <i class="icon-chevron-down"></i
                      ></span>
                    </h1>
                    <span>
                      <div
                      ...
                      >
                        ...
                        <div>
                          <a
                            href="/special/gif"
                            aria-current="page"
                            class="px-5 py-3 fs-26 d-block active text-primary"
                            >Gif动画制作</a
                          ><a
                            href="/special/adobe"
                            class="px-5 py-3 fs-26 d-block"
                            >Adobe 2021</a
                          ><a
                            href="/special/photo"
                            class="px-5 py-3 fs-26 d-block"
                            >图像处理</a
                          ><a href="/special/pm" class="px-5 py-3 fs-26 d-block"
                            >产品经理</a
                          ><a
                            href="/special/mindmap"
                            class="px-5 py-3 fs-26 d-block"
                            >思维导图</a
                          ><a
                            href="/special/manage"
                        ...
                        <a
                          ...
                          <div class="macwk-app__extend">
                            ...
                            <div class="macwk-app__extend--update">
                              <i class="icon-clock"></i> <span> 02-22 </span>
                            </div>
                          </div>
                        </a>
                      </div> -->
