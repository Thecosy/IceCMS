...
import { getallResourceComment, addResourceComment } from '../../api/webresource'
...
async function getComments(shouldScroll = false) {
  try {
    const resp = await getallResourceComment(props.resourceId)
