                        ...
                        <div v-if="item.status && item.status.includes('published')">
                          <NuxtLink :target="istarget" :to="'/post/' + item.id" class="
                            ...
                            ">
                              ...
                              <el-image v-if="item.thumb != null" class="post-item__preview delay-0" :src="item.thumb"
                                lazy>
                      ...
                      <div class="d-block siderbar-apps new-post">
                        ...
                        <div v-for="item in NewArticleComment" :key="item.id"
                          ...
                          <div class="d-flex align-items-center">
                            <div class="mr-3"><svg viewBox="0 0 264 280" version="1.1"
                                    ...
                                    <g transform="translate(825.000000, 1100.000000)">
                                      ...
                                      <g id="Avataaar" stroke-width="1" fill-rule="evenodd" fill="black"
                                        ...
                                        <g id="Body" transform="translate(32.000000, 36.000000)">
                                          ...
                                          <use fill="#FD9841" xlink:href="#path-silhouette"></use>
                                          <path
                                          ...
                                          <g id="Clothing/Blazer-+-Shirt" transform="translate(0.000000, 170.000000)">
                                            ...
                                            <g id="Shirt" transform="translate(32.000000, 29.000000)">
                                              ...
                                              <g id="Color/Palette/Black" mask="url(&quot;#BlazerShirt-mask1&quot;)"
                                                fill="#262E33">
                                                <g transform="translate(-32.000000, -29.000000)" id="🖍Color">
                                                  <rect x="0" y="0" width="264" height="110"></rect>
                                                </g>
                                              </g>
                                              <g id="Shadowy" opacity="0.16" mask="url(&quot;#BlazerShirt-mask1&quot;)"
                                                fill="#000000">
                                          ...
                                          <g transform="translate(76.000000, 82.000000)">
                                            <g id="Eyes/Side-😒" transform="translate(0.000000, 8.000000)"
                                              opacity="0.599999964">
                                              <path
                                          ...
                                          <g transform="translate(76.000000, 82.000000)">
                                            <g id="Mouth/Default" transform="translate(2.000000, 52.000000)"
                                              opacity="0.699999988">
                                              <path
                                          ...
                                          style="--avataaar-hair-color:#A55728; --avataaar-facial-hair-color:#724133; --avataaar-hat-color:#E6E6E6; --avataaar-shirt-color:#929598;">
                                          <g id="Top" strokewidth="1" fillrule="evenodd">
                                            <defs>
                                              ...
                                              <path
                                                ...
                                                id="LongHairStraight2-path2"></path>
                                              <path
                                            ...
                                            <g id="Top/Long-Hair/Straight"
                                              ...
                                              <g transform="translate(-1.000000, 0.000000)">
                                                ...
                                                <path
                                                  ...
                                                  id="Shadow" opacity="0.16" fill="#000000" fillrule="evenodd"></path>
                                              </g>
                                            </g>
                                          </g>
                                        </svg> <svg
                                          style="--avataaar-hair-color:#A55728; --avataaar-facial-hair-color:#724133; --avataaar-hat-color:#E6E6E6; --avataaar-shirt-color:#929598;">
                                          <g id="Facial-Hair/Moustache-Magnum"
                                            ...
                                            <defs>
                                              <path
                                                ...
                                                id="MoustacheMagnum-path1"></path>
                                            </defs>
                                            <mask id="MoustacheMagnum-mask1" fill="white">
                                              <use href="#MoustacheMagnum-path1"></use>
                                            </mask>
                                            <use class="CustomColor" fill="var(--avataaar-facial-hair-color)"
                                              fillrule="evenodd" href="#MoustacheMagnum-path1"></use>
                                          </g>
                                        </svg> <svg>
                                          <g id="Top/_Resources/Prescription-02" fill="none"
                                            transform="translate(62.000000, 85.000000)" stroke-width="1">
                                            <defs>
                                              <filter x="-0.8%" y="-2.4%" width="101.5%" height="109.8%"
                                                filterUnits="objectBoundingBox" id="react-filter-1166">
                                            ...
                                            <g id="Wayfarers" filter="url(#react-filter-1166)"
                                              transform="translate(6.000000, 7.000000)" fill="#252C2F">
                                              <path
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                              <p class="d-flex title fw-400 fs-14 text-ellipsis mb-0"><span
                                  class="flex">{{ item.username }}</span> <span
                                  class="d-flex justify-content-end align-items-center"><small
                                    class="text-muted">{{ item.addTime }}</small></span></p>
                            </div>
                          </div>
                        </div>
                        <!-- --------- -->
              ...
              <div id="sidetools" class="macwk-animation tinUpIn" style="display: none">
                <div class="sidetools-item">
                  <div class="sidetools-wrapper">
                    <a class="cursor"><span class="sidetools-icon kfwx"></span></a>
                  </div>
                </div>
                <div class="sidetools-item">
                  <div class="sidetools-wrapper">
                    <a class="cursor"><span class="sidetools-icon kfqq"></span></a>
                  </div>
                </div>
                <div class="sidetools-item">
                  <div class="sidetools-wrapper">
                ...
                <span>
                  <div role="tooltip" id="el-popover-3962" aria-hidden="true" class="el-popover el-popper"
                ...
                <span>
                  <div role="tooltip" id="el-popover-1793" aria-hidden="true" class="el-popover el-popper"
                    style="width: 200px; display: none">
                    <!---->
                    <div class="text-center">
                      <a href="feedback.html" class="mt-15 mb-0">在线留言</a>
...
<!-- 
<script>
import { GetArticleBtmatte } from "../asyncApi/webarticle";
...
export default {
  ...
  async asyncData({ route }) {
    let [MatterArticleFirst] = await Promise.all([
      GetArticleBtmatte({ page: route.params.id || 1 }),
    ]);
    return {
      MatterArticleFirst: MatterArticleFirst[0],
      MatterArticles: MatterArticleFirst,
  ...
  methods: {
    ...
    getNewarticleclass(id) {
      ...
      setTimeout(() => {
        ...
        this.list = lists
        this.list = this.addBackgroundStyles(this.list);
      },)
    },
    istargetJudje() {
    ...
    async getList() {
      //获取重要文章
      // let res1 = await  GetArticleBtmatte();
      // if (res1) {
      //  this.MatterArticleFirst = res1.data[0]
      //   this.MatterArticles = res1.data
      // }
      ...
      let res2 = await getAllArticle(this.listQuery, 0);
      if (res2) {
        //获取文章
        this.list = res2.data.data
        this.list = this.addBackgroundStyles(this.list);
        this.template = res2.data.data
        this.total = res2.data.total
      }
      this.listLoading = false
      let res3 = await getArticleClasslist();
      if (res3) {
        //获取分类    
        this.classlist = res3.data
      }
      let res4 = await getNewArticleComment(9);
      if (res4) {
        //获取最新评论
        this.Newarticlecomment = res4.data
      }
    },
    async getNumber() {
      let res = await getAllArticleNumber();
      if (res) {
