...
public class WxPayServiceImpl implements WxPayService {
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public Map<String, Object> nativePayForVipIntegralLogin(Integer price,Integer userid) throws Exception {

        log.info("生成订单");

        //生成订单
        OrderInfo orderInfo = orderInfoService.createOrderForVipIntegralLoginByPrice(price,"微信",userid);
        ...
        //把元为单位转化为分为单位
        Integer orderprice = orderInfo.getTotalFee();
        Integer Theprice = orderprice*100;//价格 单位:分
        amountMap.put("total", Theprice);
        amountMap.put("currency", "CNY");
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public Map<String, Object> nativePayForVipLogin(Integer price,Integer userid,Integer payid) throws Exception {

        log.info("生成订单");

        //生成订单
        OrderInfo orderInfo = orderInfoService.createOrderForVipLoginByPrice(price,"微信",userid ,payid);
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public Map<String, Object> nativePayLogin(Long ResourceId,Integer userid) throws Exception {

        log.info("生成订单");

        //生成订单
        OrderInfo orderInfo = orderInfoService.createOrderLoginByWxResourceId(ResourceId,"微信",userid);
