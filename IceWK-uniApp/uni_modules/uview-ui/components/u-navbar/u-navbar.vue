		...
		<view :class="[fixed && 'u-navbar--fixed']">
			...
			<view class="u-navbar__content" :class="[border && 'u-border-bottom']" :style="{
				...
				<view class="u-navbar__content__left" hover-class="u-navbar__content__left--hover"
					...
					<slot name="left">
						<u-icon v-if="leftIcon" :name="leftIcon" :size="leftIconSize" :color="iconColor" bold></u-icon>
						<text v-if="leftText" :color="iconColor" class="u-navbar__content__left__text">{{ leftText }}</text>
					</slot>
				</view>
