import { defineComponent, useSlots, computed, ref, provide, createBlock, openBlock, unref, withCtx, createVNode, Transition, withDirectives, createElementVNode, normalizeStyle, normalizeClass, createCommentVNode, mergeProps, createSlots, renderSlot, vShow, getCurrentInstance, watch, nextTick, h, isRef, inject, createElementBlock, toDisplayString, resolveDynamicComponent, isVNode } from 'vue';
import { NOOP, isFunction, isArray } from '@vue/shared';
import { w as withInstall, _ as _export_sfc, b as buildProps, s as useDeprecated, d as definePropType, C as useGlobalConfig, t as addUnit, A as iconPropType, c as useLocale, a as ElIcon, D as CloseComponents } from './el-button-LIU117i9.mjs';
import { i as isBoolean, e as useNamespace, j as useZIndex, k as useId, l as defaultNamespace, t as throwError, m as useTimeoutFn } from './server.mjs';
import { a as ElTeleport, b as ElFocusTrap, F as FOCUS_TRAP_INJECTION_KEY } from './index-C6mv4HvU.mjs';
...
export { ElDialog as E, composeRefs as c, flattedChildren as f };
//# sourceMappingURL=el-overlay-D0BXiGeq.mjs.map
